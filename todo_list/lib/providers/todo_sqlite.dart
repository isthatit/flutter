...
class TodoSqlite {
  ...
  Future initDb() async {
    ...
    await db.execute(
      // 'CREATE TABLE IF NOT EXIST MyTodo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title TEXT, description TEXT)',
      'CREATE TABLE MyTodo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title TEXT, description TEXT)',
    );
  }
